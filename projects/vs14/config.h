...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-version3 --disable-doc --disable-encoder=vorbis --enable-libgsm --enable-libopenjpeg --disable-avdevice --disable-devices --disable-avfilter --disable-filters --disable-bsfs --disable-bzlib --disable-avresample --enable-libmp3lame --enable-libvpx --disable-decoder=libvpx_vp8 --disable-decoder=libvpx_vp9 --disable-programs --enable-memalign-hack --enable-w32threads --enable-dxva2 --disable-decoder=dca --toolchain=msvc"
